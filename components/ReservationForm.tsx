  ...
  return (
    <>
      ...
      <form id={formId} onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div><label className="text-xs uppercase tracking-widest text-gold font-black block mb-2">Personas</label><input required type="number" min="1" max="30" value={formData.guests} onChange={e => setFormData({...formData, guests: parseInt(e.target.value)})} className="w-full bg-stone-900 border-2 border-stone-800 py-3 px-4 focus:border-gold outline-none"/></div>
